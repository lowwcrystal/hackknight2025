    ...
    >
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Calories */}
          <div className="bg-gradient-to-b from-yellow-100 to-orange-50 rounded-xl shadow-md border border-orange-200 p-0 overflow-hidden">
        ...
        <section className="mt-8">
          <h5 className="text-lg font-semibold text-orange-600 mb-4">Your Photos</h5>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {userPhotos.map((photo, idx) => (
              <div
                key={idx}
                className="relative w-full h-32 rounded-xl overflow-hidden shadow-md cursor-pointer hover:scale-105 transition-transform"
              >
                <Image
                  src={photo}
